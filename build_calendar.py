...
BROADCAST_RIGHTS = {
    "Liverpool": {"UK": "Sky Sports / TNT Sports / Amazon Prime / BBC", "NZ": "Sky Sport NOW / Sky Sport 1"},
...
def build_aggregated_calendar():
    ...
    print(f"Successfully generated RFC-compliant sports.ics with {len(out_calendar.events)} total events!")
